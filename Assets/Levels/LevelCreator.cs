...
public class LevelCreator {
    ...
    public static async Task WriteLevelFile(Level level, string path) {
    ...
    /// <returns></returns>
    public static async Task WriteLevelFile(Level level) {
        if (!Directory.Exists(LevelsFolder)) {
    ...
    public static void DeleteLevelFile(int id) {
